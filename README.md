O projeto desenvolvido é uma Calculadora de IMC (Índice de Massa Corporal) utilizando React Native. O principal objetivo é permitir que o usuário informe seu peso (em quilos) e altura (em centímetros)
